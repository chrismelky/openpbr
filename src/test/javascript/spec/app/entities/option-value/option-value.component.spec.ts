...
import { OptionValueComponent } from 'app/entities/option-value/option-value.component';
...
describe('Component Tests', () => {
    describe('OptionValue Management Component', () => {
        let comp: OptionValueComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OptionValueComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.optionValues[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
