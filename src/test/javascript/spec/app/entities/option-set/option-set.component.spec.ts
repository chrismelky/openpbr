...
import { OptionSetComponent } from 'app/entities/option-set/option-set.component';
...
describe('Component Tests', () => {
    describe('OptionSet Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.optionSets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
