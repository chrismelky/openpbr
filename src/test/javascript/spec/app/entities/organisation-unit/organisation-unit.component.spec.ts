...
import { OrganisationUnitComponent } from 'app/entities/organisation-unit/organisation-unit.component';
...
describe('Component Tests', () => {
    describe('OrganisationUnit Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.organisationUnits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
