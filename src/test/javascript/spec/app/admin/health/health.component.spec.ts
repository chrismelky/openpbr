...
import { PbrHealthCheckComponent } from 'app/admin/health/health.component';
import { PbrHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('PbrHealthCheckComponent', () => {
        let comp: PbrHealthCheckComponent;
        let fixture: ComponentFixture<PbrHealthCheckComponent>;
        let service: PbrHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [OpenpbrTestModule],
                declarations: [PbrHealthCheckComponent]
            })
                .overrideTemplate(PbrHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(PbrHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(PbrHealthService);
        });
