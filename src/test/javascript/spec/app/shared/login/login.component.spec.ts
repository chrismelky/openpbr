...
import { PbrLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: PbrLoginModalComponent;
        let fixture: ComponentFixture<PbrLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PbrLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(PbrLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(PbrLoginModalComponent);
