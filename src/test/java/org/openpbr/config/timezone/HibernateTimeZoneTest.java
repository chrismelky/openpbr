package org.openpbr.config.timezone;

import org.openpbr.OpenpbrApp;
import org.openpbr.repository.timezone.DateTimeWrapper;
import org.openpbr.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pbr_date_time_wrapper where id=%d", fieldName, id);
    }
